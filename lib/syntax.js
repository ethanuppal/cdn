...
const SyntaxHighlighter = {
    cSyntaxHighlight: function(code) {
        ...
        // Numbers
        html = html.replaceAll(/[^a-zA-Z_][0-9]+/g, `<span class='number'>$&</span>`);
        ...
        // Keywords
        html = html.replaceAll(/(#include|#define|#if|#endif|#else|#pragma|enum|if|for|while|do|return|const)(?=\W)/g, '<span class="keyword">$&</span>');
